<!-- src/views/client/ViewPrimaryPollClient.vue.vue -->
<template>
  <div>
    <div>
      <div class="profile_tittle">
        <p>
          Первинне опитування, клієнт {{ client.name }}
        </p>
      </div>
      <hr class="hr_profile">
    </div>
  ...
  setup() {
    ...
    const fetchClientData = async () => {
      ...
      try {
        ...
        const pollResponse = await apiService.getPrimaryPollData(token, clientId);
